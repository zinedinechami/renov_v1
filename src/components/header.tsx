  ...
  return (
    <>
      <nav className=" sticky top-0 w-full bg-zinc-50  h-20  border z-10 ">
        ...
        <a href="#contact">
          <button className=" absolute right-16 top-4 bebas-neue-regular sm:text-xl bg-zinc-900 hover:bg-zinc-700 text-white  py-2 px-4 border border-zinc-200 rounded-lg shadow-md">
            Contactez Nous
          </button>
        </a>
      </nav>
