...
export default function LandingPage() {
  return (
    <>
      <section
        id="home"
        className=" h-full w-full  [background:radial-gradient(125%_125%_at_50%_10%,#fafafa_50%,#1d4ed8_100%)] flex flex-col md:flex-row md:pt-20 pb-24 lg:px-44 px-4"
      >
        <div className="sm:w-3/5 mx-auto  pt-12">
          ...
          <a href="#contact">
            <button className="transition-colors bebas-neue-regular text-bol tracking-wide text-2xl bg-blue-600 hover:bg-blue-700 text-white my-6 py-2  px-8 border border-blue-500 rounded-xl shadow-lg">
