    ...
    <>
      <section className=" h-full w-full  [background:radial-gradient(125%_125%_at_50%_10%,#fafafa_50%,#14b8a6_100%)] flex flex-col md:flex-row md:pt-16 pb-24 lg:px-48 px-4">
        <div className="sm:w-3/5 mx-auto  pt-10">
          ...
          <a href="#contact">
            <button className="bebas-neue-regular text-2xl bg-emerald-400 hover:bg-emerald-500 text-white my-6 py-2 px-10 border border-emerald-500 rounded-lg shadow-lg">
