...
export default function LandingPage() {
  return (
    <>
      <section className=" h-full w-full bg-white [background:radial-gradient(125%_125%_at_50%_10%,#fafafa_50%,#14b8a6_100%)] flex flex-col md:flex-row md:pt-16 pb-24 lg:px-48 px-4">
